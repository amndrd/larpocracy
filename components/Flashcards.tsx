    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-4 flex items-center gap-4">
        ...
        <button
          ...
          className="pressable inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[0.75rem] font-semibold text-ink-2 hover:bg-white/[0.06] hover:text-ink"
        >
      ...
      <div className="flip-scene h-[21rem] sm:h-[25rem]">
        ...
        >
          ...
          >
            ...
            {carte.note && (
              <span className="mt-5 rounded-full bg-white/[0.07] px-4 py-1.5 text-center font-mono text-[0.8125rem] text-ink-2-ink">
                {carte.note}
              </span>
            )}
          </span>
      ...
      <div className="mt-5 flex items-center justify-center gap-3">
        <button
          ...
          className="pressable grid size-11 place-items-center rounded-full border border-line bg-surface text-ink-2 hover:border-ink/20 hover:bg-white/[0.06] hover:text-ink disabled:opacity-35"
        >
        ...
        <button
          ...
          className={clsx(
            ...
            'border border-no/35 bg-no-2 text-no shadow-none',
        ...
        <button
          ...
          className={clsx(
            'pressable inline-flex h-11 items-center gap-2 rounded-full px-5 text-[0.875rem] font-semibold',
            'border border-yes/35 bg-yes-2 text-yes shadow-none',
        ...
        <button
          ...
          className="pressable grid size-11 place-items-center rounded-full border border-line bg-surface text-ink-2 hover:border-ink/25 hover:bg-white/[0.06] hover:text-ink"
        >
